...
class SellController extends Controller
{
    ...
    public function sellsMaster()
    {
        ...
        $data = [
            ...
            'commodity' => CommodityMaster::where('country_id',auth()->guard('api')->user()->country_id)->whereStatus(1)->get(),
            'specification' => SpecificationMaster::where('country_id',auth()->guard('api')->user()->country_id)->whereStatus(1)->get(),
            'variety' => Variety::where('country_id',auth()->guard('api')->user()->country_id)->whereStatus(1)->get(),
            'delivery_location' => DeliveryLocation::where('country_id',auth()->guard('api')->user()->country_id)->whereStatus(1)->get(),
        ];
