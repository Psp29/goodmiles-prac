...
class DeliveryLocationController extends Controller
{
    ...
    public function index(Request $request)
    {
        try{
            if ($request->ajax()) {
                $items =  DeliveryLocation::select(['id', 'name','created_at', 'status'])->orderBy('id','desc')->where('country_id',auth()->user()->selected_country_id);
    ...
    public function store(DeliveryStoreRequest $request)
    {
        ...
        $requestdata['country_id'] = auth()->user()->selected_country_id;
