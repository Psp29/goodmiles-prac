                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="price" id="price" class="form-control"
                                            ...
                                            data-parsley-type-message="{{ __('common.bid.price_parsley_type_validation') }}"/>
    ...
    <script type="text/javascript">
        (function() {
            ...
            $('#bid_location_id').select2({
                placeholder: "{{ __('common.bid.select_location') }}",
            ...
            $('#group_id').select2({
                placeholder: "{{ __('common.bid.select_farmer_group') }}",
            }).on('select2:close', function(e) {
                $(e.target).parsley().validate();
            });
